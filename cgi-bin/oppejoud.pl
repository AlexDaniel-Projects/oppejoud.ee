...
improve the situation.');
 ...
 you just have to find one that suits you.');
    ...
    print $q->h3(__ 'I DID NOT GIVE YOU A PERMISSION TO LIST MY NAME!');
    print $q->p(__ 'Here is the deal: find the law that prohibits this, and I will delete your name immediately. You can start from', $q->a({-href => 'https://www.riigiteataja.ee/index.html'},  __ 'here') . '.');
    print $q->p(__ 'To motivate your research, here is a counter of people who succeeded in this: 0');
    print $q->h3(__ 'But I am not a professor!');
    print $q->p(__ 'If you\'re not a professor and have never been one, then it is a valid reason for removal. After all, this website is about professors, and there is no point to pollute the list with names that are not associated with this purpose.');
