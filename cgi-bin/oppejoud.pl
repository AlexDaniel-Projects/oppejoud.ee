...
improve the situation.');
 ...
 you just have to find one that suits you.');
    ...
    print $q->p(__ 'Here is the deal: find the law that prohibits this, and I will delete your name immediately. You can start from', $q->a({-href => 'https://www.riigiteataja.ee/index.html'},  'here') . '.');
